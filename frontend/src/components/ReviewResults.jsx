...
export default function ReviewResults({ result }) {
  ...
  return (
    <div style={{
      ...
      {/* SUMMARY */}
      <div className="rounded-2xl p-6 border bg-white/5 border-white/10 shadow-lg relative overflow-hidden flex-shrink-0">
        ...
        <div className="flex gap-4 mb-6 relative z-10">
          ...
          <div className="flex-1 flex flex-col items-center py-5 rounded-xl border bg-red-500/10 border-red-500/30 shadow-inner">
          ...
          <div className="flex-1 flex flex-col items-center py-5 rounded-xl border bg-amber-500/10 border-amber-500/30 shadow-inner">
          ...
          <div className="flex-1 flex flex-col items-center py-5 rounded-xl border bg-blue-500/10 border-blue-500/30 shadow-inner">
        ...
        {/* SUMMARY TEXT */}
        {summary && (
          <div className="p-4 rounded-xl bg-black/20 border border-white/5 relative z-10">
